(function ($) {
            $.fn.temporizador = function(opcoes) {
                //$.extend são funções para definir os padrões
                //caso não haja nenhum parametro na função, ele irá adotar este como padrão
                ...
                let temporizador = setInterval(() =>{
                    ...
                    if(diferencaEmMili>=0){
                        ...
                        //funcao ISOS string ajuda com que o horário saia corretamente,
                        //caso não haja toISOString, o horário resultará em um resultado com fuso horario
